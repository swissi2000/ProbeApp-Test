...
* Stylus Deflection. This is the distance a probe stylus does bend from the point when the trip force is applied to the stylus tip to the point when the whole trip force that's necessary to trip the TP is applied. The legth, diameter and meterial of the stylus as well as the required trip force are the important factors here and deflection can be very significant. As mentioned in **Trip Force Variation**, the force variation can easily exceed 50g of force. To get a good picture what kind of deflection a trip force variation of 50g can cause, enter the values of your stylus into this [Deflection Calculator](https://cmms.com/pages/deflection-calculator-tm).
